...
import { qualityEventsNavigation } from "./navigation";
import { QualityEventsProvider } from "./contexts/QualityEventsContext";
// Pages
...
const qualityEventsRoutes = {
  ...
  element: (
    ...
    <ModuleLayout
      moduleName="Quality Events"
      navigation={qualityEventsNavigation}
      className="p-6"
    />
    </QualityEventsProvider>
  ),
